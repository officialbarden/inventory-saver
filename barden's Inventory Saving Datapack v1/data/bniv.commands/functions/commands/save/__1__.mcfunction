...
# get player username.
item modify block 12345678 300 12345678 container.0 bniv.commands:fill_player_head
data modify storage minecraft:barden.names.fetch Names[].username set from block 12345678 300 12345678 Items[{Slot:0b}].tag.SkullOwner.Name
